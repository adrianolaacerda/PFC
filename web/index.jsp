...
<html>
    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <%}%>
            <form action="ControleAcesso" target="POST" >
                <center>
                    <p><input  type="text" placeholder="Login" name="txtLogin" required></p>

                    <p><input  type="password" placeholder="Senha" name="txtSenha" required></p>

                    <button type="submit" class="w3-button w3-black " value="Entrar" name="acao">Enviar</button>
                    <br>
                </center>  
            </form>
            </br> 
